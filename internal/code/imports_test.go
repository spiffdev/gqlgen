...
func TestExtractModuleName(t *testing.T) {
	...
	require.NoError(t, err)
	assert.Equal(t, "github.com/spiffdev/gqlgen", extractModuleName(content))
}
...
func TestImportPathForDir(t *testing.T) {
	...
	assert.Equal(t, "github.com/spiffdev/gqlgen/internal/code", ImportPathForDir(wd))
	...
	assert.Equal(
		t,
		"github.com/spiffdev/gqlgen/dos",

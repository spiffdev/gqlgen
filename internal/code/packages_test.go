...
func TestPackages(t *testing.T) {
	t.Run("name for existing package does not load again", func(t *testing.T) {
		...
		require.Equal(
			t,
			"a",
			p.NameForPackage("github.com/spiffdev/gqlgen/internal/code/testdata/a"),
		)
	...
	t.Run("name for unknown package makes name only load", func(t *testing.T) {
		...
		require.Equal(
			t,
			"c",
			p.NameForPackage("github.com/spiffdev/gqlgen/internal/code/testdata/c"),
		)
		require.Equal(t, 1, p.numLoadCalls)
	...
	t.Run("evicting a package causes it to load again", func(t *testing.T) {
		p := initialState(t)
		p.Evict("github.com/spiffdev/gqlgen/internal/code/testdata/b")
		require.Equal(t, "a", p.Load("github.com/spiffdev/gqlgen/internal/code/testdata/a").Name)
		require.Equal(t, 1, p.numLoadCalls)
		require.Equal(t, "b", p.Load("github.com/spiffdev/gqlgen/internal/code/testdata/b").Name)
	...
	t.Run("able to load private package with build tags", func(t *testing.T) {
		...
		p.Evict("github.com/spiffdev/gqlgen/internal/code/testdata/a")
		require.Equal(t, "a", p.Load("github.com/spiffdev/gqlgen/internal/code/testdata/a").Name)
		require.Equal(t, 2, p.numLoadCalls)
		require.Equal(t, "p", p.Load("github.com/spiffdev/gqlgen/internal/code/testdata/p").Name)
...
func TestPackagesErrors(t *testing.T) {
	...
	p := &Packages{
		...
		packages: map[string]*packages.Package{
			"github.com/spiffdev/gqlgen/internal/code/testdata/a": {
...
func TestNameForPackage(t *testing.T) {
	...
	assert.Equal(t, "api", p.NameForPackage("github.com/spiffdev/gqlgen/api"))

	// does not contain go code, should still give a valid name
	assert.Equal(t, "docs", p.NameForPackage("github.com/spiffdev/gqlgen/docs"))
...
func TestLoadAllNames(t *testing.T) {
	...
	p.LoadAllNames(
		"github.com/spiffdev/gqlgen/api",
		"github.com/spiffdev/gqlgen/docs",
		"github.com",
	)

	// should now be cached
	assert.Equal(t, 0, p.numNameCalls)
	assert.Equal(t, "api", p.importToName["github.com/spiffdev/gqlgen/api"])
	assert.Equal(t, "docs", p.importToName["github.com/spiffdev/gqlgen/docs"])
...
func initialState(t *testing.T, opts ...Option) *Packages {
	...
	pkgs := p.LoadAll(
		"github.com/spiffdev/gqlgen/internal/code/testdata/a",
		"github.com/spiffdev/gqlgen/internal/code/testdata/b",
		"./testdata/a",
		"./testdata/b",
	)

		...
		t.Run(string(execLayout), func(t *testing.T) {
			t.Run("invalid config format due to conflicting package names", func(t *testing.T) {
				...
				require.EqualError(
					t,
					config.check(),
					"exec and model define the same import path (github.com/spiffdev/gqlgen/codegen/config/generated) with different package names (graphql vs generated)",
				)
			})
			...
			t.Run("federation must have same package name as exec", func(t *testing.T) {
				...
				require.EqualError(
					t,
					config.check(),
					"exec and federation define the same import path (github.com/spiffdev/gqlgen/codegen/config/generated) with different package names (generated vs federation)",
				)
			})
...
func TestAutobinding(t *testing.T) {
	t.Run("valid paths", func(t *testing.T) {
		cfg := Config{
			...
			AutoBind: []string{
				...
				"github.com/spiffdev/gqlgen/codegen/config/testdata/autobinding/scalars/model",
			},
		...
		require.Equal(
			t,
			"github.com/spiffdev/gqlgen/codegen/config/testdata/autobinding/scalars/model.Banned",
	...
	t.Run("normalized type names", func(t *testing.T) {
		...
		require.Equal(
			t,
			"github.com/spiffdev/gqlgen/codegen/config/testdata/autobinding/chat.ProductSku",
			cfg.Models["ProductSKU"].Model[0],
		)
		require.Equal(
			t,
			"github.com/spiffdev/gqlgen/codegen/config/testdata/autobinding/chat.ChatAPI",
	...
	t.Run("protobuf getters and hasers", func(t *testing.T) {
		cfg := Config{
			Models: TypeMap{},
			AutoBind: []string{
				"github.com/spiffdev/gqlgen/codegen/config/testdata/autobinding/protomodel",
			},
		...
		require.Equal(
			t,
			"github.com/spiffdev/gqlgen/codegen/config/testdata/autobinding/protomodel.ProtoMessage",

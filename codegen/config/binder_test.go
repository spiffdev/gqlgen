...
func TestSlicePointerBinding(t *testing.T) {
	t.Run("without OmitSliceElementPointers", func(t *testing.T) {
		...
		require.Equal(
			t,
			"[]*github.com/spiffdev/gqlgen/codegen/config/testdata/autobinding/chat.Message",
			ta.GO.String(),
		)
	})
...
func TestOmittableBinding(t *testing.T) {
	t.Run("bind nullable string with Omittable[string]", func(t *testing.T) {
		...
		ot, err := binder.FindType("github.com/spiffdev/gqlgen/graphql", "Omittable")
		require.NoError(t, err)
	...
	t.Run("bind nullable object with Omittable[T]", func(t *testing.T) {
		...
		typ, err := binder.FindType(
			"github.com/spiffdev/gqlgen/codegen/config/testdata/autobinding/chat",
			"Message",
		)
		require.NoError(t, err)
...
func createBinder(cfg Config) (*Binder, *ast.Schema) {
	cfg.Models = TypeMap{
		...
		"String": TypeMapEntry{
			Model: []string{"github.com/spiffdev/gqlgen/graphql.String"},
		},
	}
...
func TestEnumBinding(t *testing.T) {
	...
	cf.Models = TypeMap{
		"Bar": TypeMapEntry{
			Model: []string{"github.com/spiffdev/gqlgen/codegen/config/testdata/enum.Bar"},
			EnumValues: map[string]EnumValue{
				"ONE": {Value: "github.com/spiffdev/gqlgen/codegen/config/testdata/enum.BarOne"},
				"TWO": {Value: "github.com/spiffdev/gqlgen/codegen/config/testdata/enum.BarTwo"},
			},
		},
		"Baz": TypeMapEntry{
			Model: []string{"github.com/spiffdev/gqlgen/graphql.Int"},
			EnumValues: map[string]EnumValue{
				"ONE": {Value: "github.com/spiffdev/gqlgen/codegen/config/testdata/enum.BazOne"},
				"TWO": {Value: "github.com/spiffdev/gqlgen/codegen/config/testdata/enum.BazTwo"},
			},
		},
		"String": TypeMapEntry{
			Model: []string{"github.com/spiffdev/gqlgen/graphql.String"},
	...
	barType, err := binder.FindType(
		"github.com/spiffdev/gqlgen/codegen/config/testdata/enum",
		"Bar",
	)
	...
	bazType, err := binder.FindType("github.com/spiffdev/gqlgen/graphql", "Int")
...
func TestTargetBinding(t *testing.T) {
	...
	cf.Models = TypeMap{
		"Int": TypeMapEntry{
			Model: []string{
				"github.com/spiffdev/gqlgen/codegen/config/testdata/binding.Number",
				"github.com/spiffdev/gqlgen/codegen/config/testdata/binding.ContextNumber",
			},
		},
	}
	cf.Schema = gqlparser.MustLoadSchema(&ast.Source{Name: "schema", Input: `
	...
	type Query {
		number: Int! @goField(type:"github.com/spiffdev/gqlgen/codegen/config/testdata/binding.Number")
	    contextNumber: Int! @goField(type:"github.com/spiffdev/gqlgen/codegen/config/testdata/binding.ContextNumber")
	}
	`})
	binder := cf.NewBinder()

	ctxTarget, err := binder.FindType(
		"github.com/spiffdev/gqlgen/codegen/config/testdata/binding",
		"ContextNumber",
	)
	require.NoError(t, err)

...
func TestImports(t *testing.T) {
	...
	aBar := "github.com/spiffdev/gqlgen/codegen/templates/testdata/a/bar"
	bBar := "github.com/spiffdev/gqlgen/codegen/templates/testdata/b/bar"
	mismatch := "github.com/spiffdev/gqlgen/codegen/templates/testdata/pkg_mismatch"
	...
	t.Run("lookup by type", func(t *testing.T) {
		...
		pkg := types.NewPackage(
			"github.com/spiffdev/gqlgen/codegen/templates/testdata/b/bar",
			"bar",
		)
		typ := types.NewNamed(
	...
	t.Run("duplicates above 10 are decollisioned", func(t *testing.T) {
		a := Imports{destDir: wd, packages: code.NewPackages()}
		for i := range 100 {
			cBar := fmt.Sprintf("github.com/spiffdev/gqlgen/codegen/templates/testdata/%d/bar", i)
			if i > 0 {
	...
	t.Run("string printing for import block", func(t *testing.T) {
		...
		require.Equal(
			t,
			`"github.com/spiffdev/gqlgen/codegen/templates/testdata/a/bar"
bar1 "github.com/spiffdev/gqlgen/codegen/templates/testdata/b/bar"
turtles "github.com/spiffdev/gqlgen/codegen/templates/testdata/pkg_mismatch"`,
			a.String(),
		)
	})
	...
	t.Run("aliased imports will not collide", func(t *testing.T) {
		...
		require.Equal(t, `abar "github.com/spiffdev/gqlgen/codegen/templates/testdata/a/bar"
bbar "github.com/spiffdev/gqlgen/codegen/templates/testdata/b/bar"`, a.String())
	})
}

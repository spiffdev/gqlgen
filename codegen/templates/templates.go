...
import (
	...
	"github.com/spiffdev/gqlgen/internal/imports"
)
...
func Render(cfg Options) error {
	...
	if cfg.GeneratedHeader {
		result.WriteString("// Code generated by github.com/spiffdev/gqlgen, DO NOT EDIT.\n\n")
	}
	if cfg.PackageDoc != "" {
...
func ref(p types.Type) string {
	...
	// see https://github.com/spiffdev/gqlgen/issues/3414#issuecomment-2822856422

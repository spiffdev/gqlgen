...
var builtins = config.TypeMap{
	"_Service": {
		Model: config.StringList{
			"github.com/spiffdev/gqlgen/plugin/federation/fedruntime.Service",
		},
	},
	"_Entity": {
		Model: config.StringList{
			"github.com/spiffdev/gqlgen/plugin/federation/fedruntime.Entity",
		},
	},
	"Entity": {
		Model: config.StringList{
	...
	"_Any": {
		Model: config.StringList{"github.com/spiffdev/gqlgen/graphql.Map"},
	},
	"federation__Scope": {

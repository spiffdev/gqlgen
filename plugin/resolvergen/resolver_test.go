...
func TestLayoutSingleFile(t *testing.T) {
	...
	assertNoErrors(t, "github.com/spiffdev/gqlgen/plugin/resolvergen/testdata/singlefile/out")
}
...
func TestLayoutSingleFileWithEnableRewrite(t *testing.T) {
	...
	assertNoErrors(
		t,
		"github.com/spiffdev/gqlgen/plugin/resolvergen/testdata/singlefile_preserve/out",
	)
}
...
func TestOmitTemplateComment(t *testing.T) {
	...
	assertNoErrors(
		t,
		"github.com/spiffdev/gqlgen/plugin/resolvergen/testdata/omit_template_comment/out",
	)
}
...
func TestResolver_Implementation(t *testing.T) {
	...
	assertNoErrors(
		t,
		"github.com/spiffdev/gqlgen/plugin/resolvergen/testdata/resolver_implementor/out",
	)
}
...
func TestCommentDirective(t *testing.T) {
	...
	assertNoErrors(
		t,
		"github.com/spiffdev/gqlgen/plugin/resolvergen/testdata/comment_directive/out",
	)
...
func testFollowSchemaPersistence(t *testing.T, dir string) {
	...
	require.NoError(t, p.GenerateCode(data))
	assertNoErrors(t, "github.com/spiffdev/gqlgen/plugin/resolvergen/"+dir+"/out")
}
